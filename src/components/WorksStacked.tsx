                ...
                <div className="flex flex-wrap gap-4 md:gap-6 reveal-item justify-center items-center">
                  {["code", "images", "demo", "tech stack"].map((tab) => (
                    <button
                      ...
                      className={`text-sm md:text-base font-bold uppercase tracking-widest px-6 py-3 rounded-full transition-colors duration-300 shadow-sm hover:shadow-lg ${work.id === 'vitalpulse'
